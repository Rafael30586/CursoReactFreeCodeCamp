export default function Entry(){
    return (
        <article> 
            <div>
                <img className="paisaje" src="https://res-4.cloudinary.com/jnto/image/upload/w_750,h_750,c_fill,f_auto,fl_lossy,q_auto/v1/media/filer_public/f8/02/f802e620-ebff-4c67-824a-f7198b95b21e/mount-fuji-banner_rchkty" alt="" />
            </div>
